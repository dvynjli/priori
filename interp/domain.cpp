...
void ProgramState::init(string domain_type, vector<string> intVars){
    fprintf(stderr, "initializing ap_man\n");
    man = initApManager(domain_type);
...
ap_environment_t* ProgramState::initEnvironment(vector<string> intVars){
...
void ProgramState::performTrasfer(ap_manager_t *man, ap_environment_t *env, ap_abstract1_t abs_val) {
        /* assign x = 1 */
