...
int main(int argc, char *argv[]) {
  ...
  pthread_create(&tw1, NULL, writer2, NULL);
  pthread_create(&tw1, NULL, writer3, NULL);
  pthread_create(&tw1, NULL, writer4, NULL);
  pthread_create(&tw1, NULL, writer5, NULL);
  pthread_create(&tw1, NULL, writer6, NULL);
  pthread_create(&tw1, NULL, writer7, NULL);
  pthread_create(&tw1, NULL, writer8, NULL);
  pthread_create(&tw1, NULL, writer9, NULL);
  pthread_create(&tw1, NULL, writer10, NULL);
  pthread_create(&tw1, NULL, writer11, NULL);
  pthread_create(&tw1, NULL, writer12, NULL);
  pthread_create(&tw1, NULL, writer13, NULL);
  pthread_create(&tw1, NULL, writer14, NULL);
  pthread_create(&tw1, NULL, writer15, NULL);
  pthread_create(&tw1, NULL, writer16, NULL);
  pthread_create(&tw1, NULL, writer17, NULL);
  pthread_create(&tw1, NULL, writer18, NULL);
  pthread_create(&tw1, NULL, writer19, NULL);
  pthread_create(&tw1, NULL, writer20, NULL);
